...
@Path("/rs/{class:accounttype|agency|bank|transaction|advisor|category|owner|transactiontype|targetTransaction|frequency|address|periodicTransaction|countryCode}")
public class Resource {
    ...
    private static Map<String, Class> createMap()
    {
        ...
        myMap.put("account", Account.class);
	...
	public List<Object> get(@PathParam("class") String pathClass) throws AccountDoesNotExistException {
		Class myClass = Resource.myMap.get(pathClass);
